...
import { WindowCreateActionMaker, WindowCloseTopActionMaker } from "./windows/windowsActions";
...
screenfull.onchange(() => {
    store.dispatch(FullscreenChangeActionMaker(screenfull.isFullscreen)); 
})
...
if(isMobile)
{
    store.dispatch(MobileChangeActionMaker(isMobile));

    window.onpopstate = function() {
    store.dispatch(WindowCloseTopActionMaker()); 
    }
}
